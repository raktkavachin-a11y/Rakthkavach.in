...
export default function App(): JSX.Element { return <QueryClientProvider client={queryClient}><I18nProvider><AuthProvider><SupabaseProvider><WouterRouter base={import.meta.env.BASE_URL.replace(/\/$/, '')}><ErrorBoundary><Switch><Route path="/" component={Login} /><Route path="/profile/complete" component={ProfileCompletion} /><Route path="/donor" component={DonorDashboard} /><Route path="/hospital" component={HospitalDashboard} /><Route path="/admin" component={AdminDashboard} /><Route><Redirect to="/" /></Route></Switch><PwaInstallPrompt /></ErrorBoundary></WouterRouter></SupabaseProvider></AuthProvider></I18nProvider></QueryClientProvider>; }
