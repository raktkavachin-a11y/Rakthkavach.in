export interface Database {
  public: {
    Tables: {
      donors: {
        Row: { id: string; full_name: string; blood_group: string; state: string | null; district: string | null; block: string | null; pincode: string | null; photo_url: string | null; aadhaar_last4: string | null; abha_id: string | null; lifetime_donations: number; latitude: number | null; longitude: number | null; verified: boolean; created_at?: string; updated_at?: string; };
        Insert: Partial<Database['public']['Tables']['donors']['Row']> & { id: string; full_name: string; blood_group: string };
